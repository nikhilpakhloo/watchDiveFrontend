  ...
  return (
    <section className="mt-24 w-full xl:px-20  px-5 relative justify-center  flex">
      ...
      <div className="absolute flex flex-col xl:gap-[24px] top-24 md:top-8 xl:top-14 md:left-[138px]">
        <h1 className="JosefinSansBold text-[40px] leading-[40px] text-white">Dive into our <br /> First Dive Sale</h1>
        <p className="MontserratRegular text-[16px] leading-[30px] text-white">Dive into savings with our first dive sale. <br /> Limited time offer!</p>
